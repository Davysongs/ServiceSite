"""
Django settings for emmaskills project.
...
SECRET_KEY = 'django-insecure-0(b(im53+611p85$*dy7v44kea6$7!2+k8#(ykxk)!mj5g71_*'
...
WSGI_APPLICATION = 'emmaskills.wsgi.application'
